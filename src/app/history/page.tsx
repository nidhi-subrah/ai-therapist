...
export default function HistoryPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#F9EDCC]">
      <div className="max-w-6xl w-full bg-white rounded-2xl shadow-xl p-8 border border-[#BDE4E1] mt-16">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#98473E] mb-2">Your Therapy Journey</h1>
          <p className="text-[#875C74]">Track your progress and reflect on your conversations</p>
        </div>

        {/* Progress Insights */}
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-semibold text-[#4A6C6F]">Progress Insights</h2>
          <Button 
            onClick={fetchConversationHistory}
            variant="outline"
            size="sm"
            className="flex items-center gap-2 border-[#BDE4E1] text-[#4A6C6F]"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <MessageCircle className="h-4 w-4 text-[#875C74]" />
              </CardHeader>
              <CardContent>
